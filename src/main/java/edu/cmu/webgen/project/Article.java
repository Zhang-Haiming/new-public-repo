...
public class Article implements Comparable<Article> {
    @NonNull private final List<SubArticle> innerArticles;
    ...
    public Article(List<AbstractContent> content, @NonNull List<SubArticle> subArticles, @NonNull String directoryName,
            @NonNull LocalDateTime created, @NonNull LocalDateTime lastUpdate) {
...
//            last = innerCreatedEvent.get();
    ...
    public @NonNull List<SubArticle> getInnerArticles() {
