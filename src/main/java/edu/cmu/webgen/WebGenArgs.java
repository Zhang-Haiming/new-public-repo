...
public class WebGenArgs {
    ...
    public WebGenArgs(String[] arguments) throws ParseException {
        ...
        this.sortingOptions.addOption(Option.builder()
                           .longOpt("sort-pinned-first")
                           .desc("Show pinned articles first, then sort by publish date (default)")
                           .build());
        this.sortingOptions.addOption(Option.builder()
                           .longOpt("sort-published")
                           .desc("Sort by publication date, newest first")
                           .build());
        this.sortingOptions.addOption(Option.builder()
                           .longOpt("sort-published-first")
                           .desc("Sort by publication date, oldest first")
                           .build());
        this.sortingOptions.addOption(Option.builder()
                           .longOpt("sort-edited")
                           .desc("Sort by date of last edit of the source file")
                           .build());
